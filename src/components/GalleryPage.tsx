...
const events = [
  {
    ...
    description: "A transformative gathering of industry leaders discussing future trends and innovations in the corporate world.",
    date: "March 15, 2024",
  ...
  },
  {
    ...
    description: "Bringing together the brightest minds in technology to showcase groundbreaking innovations and discuss future trends.",
